...
var $author$project$Popup$AdjustTimeZone = function (a) {
	return {$: 'AdjustTimeZone', a: a};
};
var $author$project$Popup$Model = F2(
	function (zone, time) {
...
var $author$project$Popup$init = function (_v0) {
	return _Utils_Tuple2(
		A2(
			$author$project$Popup$Model,
			$elm$time$Time$utc,
			$elm$time$Time$millisToPosix(0)),
		A2($elm$core$Task$perform, $author$project$Popup$AdjustTimeZone, $elm$time$Time$here));
};
var $author$project$Popup$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$Popup$subscriptions = function (model) {
	return A2($elm$time$Time$every, 1000, $author$project$Popup$Tick);
};
...
var $author$project$Popup$main = $elm$browser$Browser$element(
	{init: $author$project$Popup$init, subscriptions: $author$project$Popup$subscriptions, update: $author$project$Popup$update, view: $author$project$Popup$view});
